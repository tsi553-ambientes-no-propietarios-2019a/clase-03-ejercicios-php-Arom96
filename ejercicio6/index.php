<?php
/**
*Crear una función que determine si una palabra contiene 
*las 5 vocales sin repetir ninguna. Presentar un mensaje 
*que indique si la palabra contiene las 5 vocales 
*y cuantas letras tiene la palabra. Ejemplos:
*Murciélago
*aceituno
*acuífero
